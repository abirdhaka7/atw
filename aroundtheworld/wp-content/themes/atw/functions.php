...
// Add login Funtionality
function admin_styles(){
    wp_enqueue_style('vegasCss', get_template_directory_uri() . '/login/css/vegas.min.css', false);

    wp_enqueue_style('loginStyle', get_template_directory_uri() . '/login/css/loginStyle.css', false);
...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('featuredTour', 730, 390, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
    add_image_size('featuredblog', 1200, 444, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
    add_image_size('slider', 1500, 500, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
    add_image_size('tourFront', 430, 300, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('fancybox', get_template_directory_uri() . '/js/jquery.fancybox.js', array(), '3.5.7'); 
        wp_enqueue_script('fancybox'); // Enqueue it!

        wp_register_script('bxslider', get_template_directory_uri() . '/js/jquery.bxslider.js', array(), '4.2.12'); 
        wp_enqueue_script('bxslider'); // Enqueue it!

        wp_register_script('picture-fill', get_template_directory_uri() . '/js/picturefill.min.js', array(), '3.0.2'); 
        wp_enqueue_script('picture-fill'); // Enqueue it!

        wp_register_script('slickNavjs', get_template_directory_uri() . '/js/jquery.slicknav.min.js', array(), '1.0.10'); 
        wp_enqueue_script('slickNavjs'); // Enqueue it!
...
function html5blank_styles()
{
    ...
    wp_register_style('bxslider', get_template_directory_uri() . '/css/jquery.bxslider.css', array(), '4.2.12', 'all');
    ...
    wp_register_style('latoFont', 'https://fonts.googleapis.com/css?family=Lato:400,700&display=swap', array(), '1.0', 'all');
